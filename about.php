<?php
echo "<br><br><br><br><br><br><br><br><br>This is an online Art Gallery Management System using MySQL database, HTML and PHP.<br><br>
...
<style>
  body{
	 background-image:linear-gradient(rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.3)),url(pages/subp/paintings.jpg);
